...
let GameHistoryService = class GameHistoryService {
    ...
    constructor(gameHistoryRepository) {
        this.gameHistoryRepository = gameHistoryRepository;
    }
    async saveGame(gameState, startTime) {
    ...
    async getGamesByPlayer(playerName) {
        ...
        return games.filter(game => game.players.some(p => p.name.toLowerCase().includes(playerName.toLowerCase())));
    }
};
